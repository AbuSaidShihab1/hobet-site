...
const RecentBigWins = () => {
  ...
  <div className="w-full flex justify-start items-center gap-[15px] pb-[20px] pt-[10px]">
  <div className="flex  items-center text-lg font-bold">
        <span className="text-green-400 mr-2 text-[20px] animate-pulse">●</span>
      ...
      <div className="overflow-hidden bg-gray-900  rounded-lg p-2">
        ...
        <div
        key={index}
        className="mx-[2px] text-center w-28 flex flex-col justify-between px-[5px] py-2 rounded-lg "
      >
        <img
          src={game.image}
          alt={game.name}
          className="rounded-lg mb-2 w-full h-[120px] object-cover"
        />
   <div className="flex items-center justify-center space-x-1 mb-[3px]">
    <FaUser className={`text-[16px] ${getRandomColor()}`} />
    <p className={`text-[13px] font-medium `}>
      {game.user}
    </p>
  </div>
  
  <p className="text-[13px] text-green-400 font-bold">{game.amount}</p>
      </div>
